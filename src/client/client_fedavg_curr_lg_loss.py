...
class Client_FedAvg_Curr_LG_Loss(object):
    score_data_indices = {};
    train_count = {};
    ...
    def __init__(self, name, model, local_bs, local_ep, lr0, lr_a, lr_b, momentum, w_decay, device, 
        ...
        self.acc_best = 0
        Client_FedAvg_Curr_LG_Loss.train_count[self.name]=0
        self.save_best = True
    ...
    def train(self, w_glob, logger = None):
        Client_FedAvg_Curr_LG_Loss.train_count[self.name]+=1
        ...
        if logger:
            ...
            for idx in Client_FedAvg_Curr_LG_Loss.score_data_indices[self.name]:
                trace = {}

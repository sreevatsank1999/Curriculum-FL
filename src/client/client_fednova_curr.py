...
class Client_FedNova_Curr(object):
    score_data_indices = {};
    train_count = {};
    ...
    def __init__(self, name, model, local_bs, local_ep, lr0, lr_a, lr_b, momentum, w_decay, device, 
        ...
        self.acc_best = 0
        Client_FedNova_Curr.train_count[self.name]=0
        self.save_best = True
    ...
    def train(self, w_glob, logger = None):
        Client_FedNova_Curr.train_count[self.name]+=1
        ...
        if logger:
            ...
            for idx in Client_FedNova_Curr.score_data_indices[self.name]:
                trace = {}
        ...
        return sum(epoch_loss) / len(epoch_loss), step, a_i, norm_grad

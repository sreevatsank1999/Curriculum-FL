...
def args_parser():
    ...
    parser.add_argument('--local_ep', type=float, default=10, help="the number of local epochs: E")
    parser.add_argument('--local_bs', type=int, default=10, help="local batch size: B")
    parser.add_argument('--lr0', type=float, default=0.01, help="init learning rate")
    parser.add_argument('--lr_sched_a', type=float, default=0.001, help="learning rate exp decay param a")
    parser.add_argument('--lr_sched_b', type=float, default=0.75, help="learning rate exp decay param b")
    parser.add_argument('--momentum', type=float, default=0.9, help="SGD momentum (default: 0.9)")
    parser.add_argument('--w_decay', type=float, default=5e-4, help="Target domain alignment weight decay")
    parser.add_argument('--glob_momentum', type=float, default=0.0, help="momentum on global model (default: 0.0)")
    ...
    # pFedMe  arguments
    parser.add_argument('--pfedme_lambd', type=float, default=0.0, help="lambda for pFedMe")
    parser.add_argument('--pfedme_K', type=int, default=5, help='pFedMe local model update freq')
    parser.add_argument('--pfedme_eta', type=float, default=0.0, help="local model lr parameter eta for pFedMe")
    parser.add_argument('--pfedme_beta', type=float, default=0.0, help="mixing parameter beta for pFedMe")
    ...
    parser.add_argument('--partition_difficulty_dist', type=str, default='rand', help='distribution of data partitions in the order of difficulty. default: rand')
    parser.add_argument('--partition_ordering_f', type=float, default=1.0, help='Fraction of the dataset to order, default: 1.0')
    parser.add_argument('--num_partitions', type=int, default=200, help='Number of partitions to divide the dataset into')
    ...
    parser.add_argument('--beta', type=float, default=0.5, help='The parameter for the dirichlet distribution for data'\
                        'partitioning')
    parser.add_argument('--local_view', type=bool, default=False, help='whether from client perspective or not')
    parser.add_argument('--batch_size', type=int, default=64, help="test batch size")
    parser.add_argument('--noise', type=float, default=0, help='how much noise we add to some party')
    parser.add_argument('--noise_type', type=str, default='level', help='Different level of noise or different space of noise')
    
    #logging parameters
    parser.add_argument('--log_clientnet', type=str, default='False', help='Enable logging of client network weights, Note: compute intensive')
    parser.add_argument('--data_score_sample_p', type=float, default=0.001, help='coin flip probability values for inclusion of datapoint for data score logging')
    parser.add_argument('--client_score_sample_n', type=int, default=1, help='nummber of clients for client score logging')
    
    # Curriculum arguments
    parser.add_argument('--ordering', type=str, default='curr', help='curriculum ordering. default: curriculm')
    parser.add_argument('--pacing_f', type=str, default='linear', help='pacing function. default: linear')
    parser.add_argument('--pacing_a', default=0.2, type=float, help='pacing_a (default: 0.2)')
    parser.add_argument('--pacing_b', default=0.2, type=float, help='pacing_b (default: 0.2)')
    parser.add_argument('--lg_scoring', type=str, default='G', help='lg method of scoring (default: G)')
    parser.add_argument('--train_expert', type=str, default='False', help='train expert if does not exist')
    
    # Client Curriculum arguments
    parser.add_argument('--client_ordering', type=str, default='curr', help='client curriculum ordering. default: curriculm')
    parser.add_argument('--client_pacing_f', type=str, default='linear', help='pacing function. default: linear')
    parser.add_argument('--client_pacing_a', default=0.2, type=float, help='pacing_a (default: 0.2)')
    parser.add_argument('--client_pacing_b', default=0.4, type=float, help='pacing_b (default: 0.4)')
    parser.add_argument('--client_bs', type=int, default=8, help="client batch size: B")

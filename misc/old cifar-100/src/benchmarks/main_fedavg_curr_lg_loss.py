...
def main_fedavg_curr_lg_loss(args):
    ...
    print(f'-- FedAvg_Curr_LG_Loss+ :: AVG Local Acc: {np.mean(local_acc):.2f}')
...
def run_fedavg_curr_lg_loss(args, fname):
    ...
    for trial in range(args.ntrials):
        ...
        fedavg_ft_local, duration = main_fedavg_curr_lg_loss(args)
        ...
        print(f'-- FedAvg_Curr_LG_Loss+ Fine Tuning Clients AVG Local Acc: {exp_fedavg_ft_local[-1]:.2f}')

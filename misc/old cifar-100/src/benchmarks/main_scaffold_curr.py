...
def main_scaffold_curr(args):
    ...
    for idx in range(args.num_users):
        ...
        clients.append(Client_Scaffold_Curr(idx, copy.deepcopy(users_model[idx]), args.local_bs, args.local_ep, 
                                            ...
                                            args.ordering, args.pacing_f, args.pacing_a, args.pacing_b, c_local))
...
def run_scaffold_curr(args, fname):
    ...
    for trial in range(args.ntrials):
        ...
        scaffold_ft_local, duration = main_scaffold_curr(args)
    ...
    template = '-- Scaffold+ Fine Tuning Clients AVG Local Acc: {:.3f} +- {:.3f}' 
